    ...
    <view class="uni-data-tree-input" @click="handleInput">
      <slot :options="options" :data="inputSelected" :error="errorMessage">
        <view class="input-value" :class="{'input-value-border': border}">
          ...
          <scroll-view v-else-if="inputSelected.length" :style="styleObject" class="selected-area" scroll-x="true">
          ...
          <text v-else :style="styleObject" class="selected-area placeholder">{{placeholder}}</text>
