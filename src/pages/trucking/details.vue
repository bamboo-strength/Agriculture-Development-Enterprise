      ...
      <view class="uni-tabs--content">
        <view v-if="tabsIndex === 0">
          <uni-list style="margin-top: 4px;">
            <uni-list-item title="派车单号" :rightText="dispatchForm.dispatchNo"></uni-list-item>
            ...
            <uni-list-item title="客户名称" :rightText="dispatchForm.custName"></uni-list-item>
        ...
        <view v-else>
          <uni-list style="margin-top: 4px;">
            ...
            <template v-else>
              ...
              <uni-list-item title="一磅时间" :rightText="dispatchForm.firstTime"></uni-list-item>
              <uni-list-item title="二磅时间" :rightText="dispatchForm.secondTime"></uni-list-item>
            </template>
          </uni-list>
      ...
      getDispatch(dispatchId) {
        truckingOrderApi.getDispatchById({ id: dispatchId })
          .then(result => {
            ...
            this.weightCode = `派车单号: ${result.dispatchNo}\n 所属机构: ${result.organization.name}\n 物资名称: ${result.materialName}\n 客户名称: ${result.custName}\n 称重序号: ${result.weightNo}\n 皮重: ${result.tareWeight}吨\n 毛重: ${result.grossWeight}吨\n 净重: ${result.netWeight}吨\n 预装量: ${result.preamount}吨\n 实收量: ${result.receiveAmount ? result.receiveAmount : 0}吨`
          })
      },
